...
--
-- Tabelstructuur voor tabel `sessies` (bedden)
--
...
INSERT INTO `sessies` (`id`, `status`, `locatie`) VALUES
(1, 0, 'Kamer 101'),
(2, 0, 'Kamer 102'),
(3, 0, 'Kamer 201'),
(4, 0, 'Kamer 202');
...
CREATE TABLE IF NOT EXISTS `patiënten` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `voornaam` varchar(255) DEFAULT NULL,
  `familienaam` varchar(255) DEFAULT NULL,
  `emailadres` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IPatiënt_naam` (`familienaam`, `voornaam`),
  KEY `IPatiënt_email` (`emailadres`),
  KEY `FKPatiënt_bed` (`bed_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=1 ;
...
--
-- Beperkingen voor tabel `patiënten`
--
ALTER TABLE `patiënten`
  ADD CONSTRAINT `FKPatiënt_bed` FOREIGN KEY (`bed_id`) REFERENCES `sessies` (`id`);
